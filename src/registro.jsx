        ...
        <div className="login-container">
            ...
            <div className="login-info">
                ...
                <div className="login-fill-box-container">
                    ...
                    <div className='login-fill-box-fecha'>
                        <select name="dia" className='login-fill-box box-dia'>
                            <option value=""></option>
                        ...
                        <select name='mes' className="login-fill-box box-mes">
                            <option value=""></option>
                        ...
                        <select name='año' className="login-fill-box box-año">
